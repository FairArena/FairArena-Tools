        ...
        <CardContent className="space-y-6">
          ...
          <Card>
            <CardContent className="pt-6">
              <h4 className="font-semibold mb-2">UUID {version.toUpperCase()}</h4>
              <div className="text-sm text-muted-foreground">
                {version === 'v4' && (
                  <p>
                    Version 4 UUIDs are randomly generated and provide the highest entropy. They are
                    suitable for most applications where uniqueness is the primary requirement.
                  </p>
                )}
                {version === 'v1' && (
                  <p>
                    Version 1 UUIDs are based on timestamp and MAC address. They can reveal when and
                    where the UUID was generated, which may be a privacy concern.
                  </p>
                )}
              </div>
            </CardContent>
                ...
                <ScrollArea className="h-96">
                  <div className="space-y-2">
                    {uuids.map((uuid, index) => (
                      ...
                      >
                        <div className="font-mono text-sm break-all flex-1 mr-2">{uuid}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-sm text-muted-foreground space-y-2">
                <p>
                  <strong>UUID (Universally Unique Identifier):</strong> A 128-bit number used to
                  uniquely identify information in computer systems.
                </p>
                <p>
                  <strong>Format:</strong> 8-4-4-4-12 hexadecimal digits, totaling 36 characters
                  including hyphens.
                </p>
                <p>
                  <strong>Uniqueness:</strong> The probability of generating duplicate UUIDs is
                  extremely low (approximately 2^128 possibilities).
                </p>
                <p>
                  <strong>Use Cases:</strong> Database keys, session IDs, resource identifiers, and
                  anywhere unique identification is needed.
                </p>
              </div>
            </CardContent>
          </Card>
