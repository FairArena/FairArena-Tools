      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="space-y-2">
            <label className="block text-sm text-neutral-300 font-medium">JWT Token</label>
            <textarea
              value={jwt}
              onChange={(e) => setJwt(e.target.value)}
              placeholder="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c"
              className="w-full bg-neutral-800/50 border border-neutral-700 rounded-lg text-white placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all duration-200 font-mono text-sm h-32 resize-none p-4"
            />
          </div>
          ...
          {decoded && (
            <div className="space-y-6">
              {/* Status badges */}
              <div className="flex flex-wrap items-center gap-3 p-4 bg-neutral-800/40 rounded-lg border border-neutral-700/50">
                ...
                <span className="text-xs text-neutral-400 ml-auto">Signature not validated</span>
              </div>
              ...
              <Tabs defaultValue="payload">
                ...
                <TabsContent value="header" className="mt-4">
                  <div className="space-y-4">
                    ...
                    <div className="bg-neutral-900/50 p-4 rounded-lg border border-neutral-700/30">
                    ...
                    {decoded.payload && (
                      <div className="space-y-6">
                        ...
                        <div className="border-t border-neutral-700/50 pt-6">
                          <h5 className="text-neutral-300 font-semibold mb-4">Standard Claims</h5>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {decoded.payload.iss && (
                              <div className="bg-neutral-800/40 p-3 rounded-lg border border-neutral-700/30">
                            ...
                            {decoded.payload.exp && (
                              <div className="bg-neutral-800/40 p-3 rounded-lg border border-neutral-700/30">
                                ...
                                <div
                                  className={`font-mono text-sm mt-1 ${decoded.expired ? 'text-neutral-500' : 'text-brand-500'}`}
                                >
